    ...
    <footer className="bg-[#1C092F]">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
            ...
            <form className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
              <input
                ...
                className="flex-1 md:w-72 px-5 py-3 rounded-full bg-white/10 border border-white/30 focus:outline-none focus:border-white text-white placeholder:text-white/50 text-sm"
              />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3 mb-4 md:mb-6">
              <img src={logo} alt="Reselience Gold" className="h-20 md:h-24 w-auto" />
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-white">{isRTL ? 'جودة ملكية' : 'Royal Quality'}</span>
            </div>
          </div>

          {/* Quick Links */}
          <div>
            <h4 className="font-serif text-base md:text-lg font-bold text-white mb-4 md:mb-6 flex items-center gap-2">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <ul className="space-y-3 md:space-y-4">
              <li className="flex items-center gap-3 md:gap-4 text-sm text-white/70">
                <div className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-white/10 flex items-center justify-center border border-white/30 shrink-0">
            ...
            <div className="flex items-center gap-2 md:gap-3 mt-4 md:mt-6">
              <a
                ...
                className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-white/10 border border-white/30 flex items-center justify-center hover:bg-[#D4AF37] hover:text-[#1C092F] hover:border-[#D4AF37] transition-all duration-300 text-white"
              >
      ...
      <div className="border-t border-[#D4AF37]/20">
        <div className="container mx-auto px-6 py-4 md:py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-3 md:gap-4 text-xs md:text-sm text-white/70">
