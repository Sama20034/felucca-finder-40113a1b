    ...
    <footer className="bg-[#1C092F]">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <form className="flex gap-3 w-full md:w-auto">
              <input
                ...
                className="flex-1 md:w-72 px-5 py-3 rounded-full bg-[#D4AF37]/10 border border-[#D4AF37]/30 focus:outline-none focus:border-[#D4AF37] text-[#D4AF37] placeholder:text-[#D4AF37]/50"
              />
              <button className="bg-[#D4AF37] text-[#1C092F] px-6 py-3 rounded-full font-semibold flex items-center gap-2 hover:bg-[#D4AF37]/90 transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              <img src={logo} alt="Reselience Gold" className="h-20 w-auto" />
            </div>
            <p className="text-[#D4AF37]/70 text-sm leading-relaxed mb-6">
              {isRTL 
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-serif text-lg font-bold text-[#D4AF37] mb-6 flex items-center gap-2">
              <span className="w-8 h-0.5 bg-[#D4AF37] rounded-full"></span>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-4 text-sm text-[#D4AF37]/70">
            ...
            <div className="flex items-center gap-3 mt-6">
              <a
                ...
                className="w-10 h-10 rounded-full bg-[#D4AF37]/10 border border-[#D4AF37]/30 flex items-center justify-center hover:bg-[#D4AF37] hover:text-[#1C092F] hover:border-[#D4AF37] transition-all duration-300 text-[#D4AF37]"
              >
      ...
      <div className="border-t border-[#D4AF37]/20">
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-[#D4AF37]/70">
