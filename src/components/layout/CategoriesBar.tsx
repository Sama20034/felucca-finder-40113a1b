...
const CategoriesBar = () => {
  ...
  return (
    <div className="bg-secondary/60 backdrop-blur-sm border-b border-border/30 hidden lg:block">
        ...
        <nav className="flex items-center justify-center gap-8 py-3">
          {filteredCollections.map((collection: ShopifyCollection) => (
            <Link
              ...
              className="text-sm font-semibold text-foreground hover:text-primary transition-colors duration-200 relative py-1
